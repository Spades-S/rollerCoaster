...
(function ($) {
    ...
    /*===========================
     Get Dom libraries
     ===========================*/
    var addLibraryPlugin = function addLibraryPlugin(lib) {
...
+function ($) {
    ...
    var PhotoBrowser = function PhotoBrowser(params) {
        ...
        for (i = 0; i < pb.params.photos.length; i++) {
            ...
            } else if ((typeof photo === 'undefined' ? 'undefined' : (0, _typeof3.default)(photo)) === 'object') {
...
//# sourceMappingURL=light7-swiper.js.map
//# sourceMappingURL=light7-swiper.js.map