      ...
      if (this) {
        var c = function c(a) {
          for (var b = [], c = 0; c < a.length; c++) {
            var d = a[c];"请选择" !== d.name && b.push(d.name);
          }return b.length ? b : [""];
        },
            d = function d(a) {
          ...
          for (var c = 0; c < g.length; c++) {
            if (g[c].name === a) for (var e = 0; e < g[c].sub.length; e++) {
          ...
          return a.name;
            ...
            l = i[0],
            m = j[0],
            n = { cssClass: "city-picker", rotateEffect: !1, onChange: function onChange(a, b, c) {
            var d,
                g = b[0];if (g !== k) {
              var h = e(g);d = h[0];var i = f(g, d);return a.cols[1].replaceValues(h), a.cols[2].replaceValues(i), k = g, l = d, void a.updateValue();
            }d = a.cols[1].value, d !== l && (a.cols[2].replaceValues(f(g, d)), l = d, a.updateValue());
          }, cols: [{ values: h, cssClass: "col-province" }, { values: i, cssClass: "col-city" }, { values: j, cssClass: "col-district" }] },
            o = a.extend(n, b),
            p = a(this).val();p && (o.value = p.split(" "), o.value[0] && (k = o.value[0], o.cols[1].values = e(o.value[0])), o.value[1] ? (l = o.value[1], o.cols[2].values = f(o.value[0], o.value[1])) : (m = o.value[2], o.cols[2].values = f(o.value[0], o.cols[1].values[0]))), a(this).picker(o);
      }
    });
  };
}($);
//# sourceMappingURL=light7-city-picker.min.js.map
//# sourceMappingURL=light7-city-picker.min.js.map