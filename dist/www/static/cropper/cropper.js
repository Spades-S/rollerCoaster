...
(function (global, factory) {
  (typeof exports === 'undefined' ? 'undefined' : (0, _typeof4.default)(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global.Cropper = factory();
})(undefined, function () {
  'use strict';
  ...
  function extend(obj) {
    ...
    if (isObject(obj) && args.length > 0) {
      if (_assign2.default) {
        return _assign2.default.apply(Object, [obj].concat(args));
      }
  ...
  var handlers = {
    ...
    cropStart: function cropStart(event) {
      ...
      if ((0, _keys2.default)(pointers).length > 1 && options.zoomable && options.zoomOnTouch) {
        action = 'zoom';
      } else {
    ...
    cropEnd: function cropEnd(event) {
      ...
      if (!(0, _keys2.default)(pointers).length) {
        self.action = '';
      }
  ...
  var change$1 = {
    change: function change(e) {
      ...
      var pointers = self.pointers;
      var pointer = pointers[(0, _keys2.default)(pointers)[0]];
      var range = {
    ...
    zoomTo: function zoomTo(ratio, _originalEvent) {
      ...
      if (ratio >= 0 && self.ready && !self.disabled && options.zoomable) {
        ...
        if (_originalEvent) {
          ...
          var center = pointers && (0, _keys2.default)(pointers).length ? getPointersCenter(pointers) : {
